...
## This program creates a final phenotype (predictor variables) file for NEW PHENOTYPE information (includes gender, race, education)
## Then a linear regression model is run between these phenotypes and DIFFERENCE BETWEEN ONE YEAR AND BASELINE p-factor and all 5 factor scores
...
#Function to read abcd phenotypes files
...
phenotypes_new = c('gender_dummy', 'race_dummy_1', 'race_dummy_2', 'race_dummy_3', 
                     'race_dummy_4', 'educ_dummy_1', 'educ_dummy_2', 'educ_dummy_3', 
                     'educ_dummy_4', 'educ_dummy_5', 'marital_dummy', 'income_dummy_1',
                     'income_dummy_2')
...
# declare the phenotypes set we're interested in modelling
# 'phenotypes below can be any one of the three list of phenotypes defined above
phenotypes = phenotypes_new #phenotypes_nonksads  #phenotypes_ksads  #phenotypes_demo
...
######STEP 6 :SAVE AS CSV
write.csv(full_res, file='16OneNewRes.csv', quote=FALSE, row.names=FALSE)
