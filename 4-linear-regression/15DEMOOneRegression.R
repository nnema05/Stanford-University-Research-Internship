...
## This program creates a final phenotype (predictor variables) file for DEMOGRAPHIC information 
## Then a linear regression model is run between these phenotypes and THE DIFFERENCE BEWTEEN ONE YEAR AND BASELINE p-factor and all 5 factor scores
...
phenotypes = phenotypes_demo #phenotypes_ksads #phenotypes_nonksads  
...
######STEP 6 :SAVE AS CSV
write.csv(full_res, file='15OneDemoRes.csv', quote=FALSE, row.names=FALSE)