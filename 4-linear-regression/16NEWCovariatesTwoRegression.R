...
## Then a linear regression model is run between these phenotypes and DIFFERENCE BETWEEN TWO YEAR AND BASELINE p-factor and all 5 factor scores
...
######STEP 6 :SAVE AS CSV
write.csv(full_res, file='16TwoNewRes.csv', quote=FALSE, row.names=FALSE)