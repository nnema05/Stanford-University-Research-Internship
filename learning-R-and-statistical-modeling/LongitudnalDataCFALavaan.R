...
baseFactor1 =~
`baseAttacks/theatens`*NA
+`baseAttacks/threatens`*lambda1
+basecbcl_q16_p*lambda2
+`baseDisobeys rules`*lambda3
+basecbcl_q37_p*lambda4
+basecbcl_q95_p*lambda5
+basecbcl_q03_p*lambda6
+baseDestorys*lambda7
+basecbcl_q68_p*lambda8
+basecbcl_q26_p*lambda9
+basecbcl_q90_p*lambda10
+basecbcl_q94_p*lambda11
+baseSteals*lambda12
+basecbcl_q86_p*lambda13
+basecbcl_q43_p*lambda14
+basecbcl_q15_p*lambda15
+basecbcl_q67_p*lambda16
+basecbcl_q87_p*lambda17
+basecbcl_q27_p*lambda18
+`basePeer Problems`*lambda19
+basecbcl_q89_p*lambda20
+basecbcl_q19_p*lambda21
+basecbcl_q96_p*lambda22
+basecbcl_q39_p*lambda23
+basecbcl_q34_p*lambda24
+basecbcl_q72_p*lambda25
+basecbcl_q88_p*lambda26
+basecbcl_q74_p*lambda27
+basecbcl_q07_p*lambda28
+basecbcl_q109_p*lambda29
oneFactor1 =~
`oneAttacks/theatens`*NA
+`oneAttacks/threatens`*lambda1
+onecbcl_q16_p*lambda2
+`oneDisobeys rules`*lambda3
+onecbcl_q37_p*lambda4
+onecbcl_q95_p*lambda5
+onecbcl_q03_p*lambda6
+oneDestorys*lambda7
+onecbcl_q68_p*lambda8
+onecbcl_q26_p*lambda9
+onecbcl_q90_p*lambda10
+onecbcl_q94_p*lambda11
+oneSteals*lambda12
+onecbcl_q86_p*lambda13
+onecbcl_q43_p*lambda14
+onecbcl_q15_p*lambda15
+onecbcl_q67_p*lambda16
+onecbcl_q87_p*lambda17
+onecbcl_q27_p*lambda18
+`onePeer Problems`*lambda19
+onecbcl_q89_p*lambda20
+onecbcl_q19_p*lambda21
+onecbcl_q96_p*lambda22
+onecbcl_q39_p*lambda23
+onecbcl_q34_p*lambda24
+onecbcl_q72_p*lambda25
+onecbcl_q88_p*lambda26
+onecbcl_q74_p*lambda27
+onecbcl_q07_p*lambda28
+onecbcl_q109_p*lambda29
baseFactor2 =~
NA*basecbcl_q50_p
+ basecbcl_q50_p*lambda1
+ basecbcl_q112_p*lambda2
+ basecbcl_q32_p*lambda3
+ basecbcl_q52_p*lambda4
+ basecbcl_q45_p*lambda5
+ basecbcl_q31_p*lambda6
+ basecbcl_q35_p*lambda7
+ basecbcl_q71_p*lambda8
+ basecbcl_q30_p*lambda9
+ basecbcl_q29_p*lambda10
+ basecbcl_q12_p*lambda11
oneFactor2 =~
NA*onecbcl_q50_p
+ onecbcl_q50_p*lambda1
+ onecbcl_q112_p*lambda2
+ onecbcl_q32_p*lambda3
+ onecbcl_q52_p*lambda4
+ onecbcl_q45_p*lambda5
+ onecbcl_q31_p*lambda6
+ onecbcl_q35_p*lambda7
+ onecbcl_q71_p*lambda8
+ onecbcl_q30_p*lambda9
+ onecbcl_q29_p*lambda10
+ onecbcl_q12_p*lambda11
baseFactor3 =~ `baseDistracted/Hyperactive`*NA
+`baseDistracted/Hyperactive`*lambda1
+basecbcl_q17_p*lambda2
+basecbcl_q80_p*lambda3
+basecbcl_q13_p*lambda4
+basecbcl_q62_p*lambda5
+basecbcl_q46_p*lambda6
+basecbcl_q04_p*lambda7
+basecbcl_q93_p*lambda8
+basecbcl_q09_p*lambda10
+basecbcl_q61_p*lambda11
+basecbcl_q66_p*lambda12
+basecbcl_q85_p*lambda13
+basecbcl_q01_p*lambda14
+basecbcl_q36_p*lambda15
+basecbcl_q64_p*lambda16
oneFactor3 =~ `oneDistracted/Hyperactive`*NA
+`oneDistracted/Hyperactive`*lambda1
+onecbcl_q17_p*lambda2
+onecbcl_q80_p*lambda3
+onecbcl_q13_p*lambda4
+onecbcl_q62_p*lambda5
+onecbcl_q46_p*lambda6
+onecbcl_q04_p*lambda7
+onecbcl_q93_p*lambda8
+onecbcl_q09_p*lambda10
+onecbcl_q61_p*lambda11
+onecbcl_q66_p*lambda12
+onecbcl_q85_p*lambda13
+onecbcl_q01_p*lambda14
+onecbcl_q36_p*lambda15
+onecbcl_q64_p*lambda16
baseFactor4 =~ 
basecbcl_q56c_p*lambda1
+basecbcl_q56f_p*lambda2
+basecbcl_q56g_p*lambda3
+basecbcl_q56b_p*lambda4
+basecbcl_q56a_p*lambda5
+basecbcl_q51_p*lambda6
+basecbcl_q56h_p*lambda7
+basecbcl_q56d_p*lambda8
+basecbcl_q56e_p*lambda9
oneFactor4 =~ 
onecbcl_q56c_p*lambda1
+onecbcl_q56f_p*lambda2
+onecbcl_q56g_p*lambda3
+onecbcl_q56b_p*lambda4
+onecbcl_q56a_p*lambda5
+onecbcl_q51_p*lambda6
+onecbcl_q56h_p*lambda7
+onecbcl_q56d_p*lambda8
+onecbcl_q56e_p*lambda9
baseFactor5 =~ 
basecbcl_q111_p*lambda1
basecbcl_q42_p*lambda2
basecbcl_q75_p*lambda3
basecbcl_q65_p*lambda4
basecbcl_q102_p*lambda5
oneFactor5 =~ 
onecbcl_q111_p*lambda1
onecbcl_q42_p*lambda2
onecbcl_q75_p*lambda3
onecbcl_q65_p*lambda4
onecbcl_q102_p*lambda5
'
...
+basecbcl_q109_p*lambda29
twoFactor1 =~
`twoAttacks/theatens`*NA1
+`twoAttacks/threatens`*lambda1
+twocbcl_q16_p*lambda2
+`twoDisobeys rules`*lambda3
+twocbcl_q37_p*lambda4
+twocbcl_q95_p*lambda5
+twocbcl_q03_p*lambda6
+twoDestorys*lambda7
+twocbcl_q68_p*lambda8
+twocbcl_q26_p*lambda9
+twocbcl_q90_p*lambda10
+twocbcl_q94_p*lambda11
+twoSteals*lambda12
+twocbcl_q86_p*lambda13
+twocbcl_q43_p*lambda14
+twocbcl_q15_p*lambda15
+twocbcl_q67_p*lambda16
+twocbcl_q87_p*lambda17
+twocbcl_q27_p*lambda18
+`twoPeer Problems`*lambda19
+twocbcl_q89_p*lambda20
+twocbcl_q19_p*lambda21
+twocbcl_q96_p*lambda22
+twocbcl_q39_p*lambda23
+twocbcl_q34_p*lambda24
+twocbcl_q72_p*lambda25
+twocbcl_q88_p*lambda26
+twocbcl_q74_p*lambda27
+twocbcl_q07_p*lambda28
+twocbcl_q109_p*lambda29
baseFactor2 =~
NA1*basecbcl_q50_p
+ basecbcl_q50_p*lambda1
+ basecbcl_q112_p*lambda2
...
twoFactor2 =~
NA1*twocbcl_q50_p
+ twocbcl_q50_p*lambda1
+ twocbcl_q112_p*lambda2
+ twocbcl_q32_p*lambda3
+ twocbcl_q52_p*lambda4
+ twocbcl_q45_p*lambda5
+ twocbcl_q31_p*lambda6
+ twocbcl_q35_p*lambda7
+ twocbcl_q71_p*lambda8
+ twocbcl_q30_p*lambda9
+ twocbcl_q29_p*lambda10
+ twocbcl_q12_p*lambda11
baseFactor3 =~ `baseDistracted/Hyperactive`*NA1
+`baseDistracted/Hyperactive`*lambda1
+basecbcl_q17_p*lambda2
+basecbcl_q80_p*lambda3
+basecbcl_q13_p*lambda4
...
+basecbcl_q36_p*lambda15
+basecbcl_q64_p*lambda16
twoFactor3 =~ `twoDistracted/Hyperactive`*NA1
+`twoDistracted/Hyperactive`*lambda1
+twocbcl_q17_p*lambda2
+twocbcl_q80_p*lambda3
+twocbcl_q13_p*lambda4
+twocbcl_q62_p*lambda5
+twocbcl_q46_p*lambda6
+twocbcl_q04_p*lambda7
+twocbcl_q93_p*lambda8
+twocbcl_q09_p*lambda10
+twocbcl_q61_p*lambda11
+twocbcl_q66_p*lambda12
+twocbcl_q85_p*lambda13
+twocbcl_q01_p*lambda14
+twocbcl_q36_p*lambda15
+twocbcl_q64_p*lambda16
baseFactor4 =~ 
basecbcl_q56c_p*lambda1
+basecbcl_q56f_p*lambda2
+basecbcl_q56g_p*lambda3
...
+basecbcl_q56e_p*lambda9
twoFactor4 =~ 
twocbcl_q56c_p*lambda1
+twocbcl_q56f_p*lambda2
+twocbcl_q56g_p*lambda3
+twocbcl_q56b_p*lambda4
+twocbcl_q56a_p*lambda5
+twocbcl_q51_p*lambda6
+twocbcl_q56h_p*lambda7
+twocbcl_q56d_p*lambda8
+twocbcl_q56e_p*lambda9
baseFactor5 =~ 
basecbcl_q111_p*lambda1
basecbcl_q42_p*lambda2
basecbcl_q75_p*lambda3
...
basecbcl_q102_p*lambda5
twoFactor5 =~ 
twocbcl_q111_p*lambda1
twocbcl_q42_p*lambda2
twocbcl_q75_p*lambda3
twocbcl_q65_p*lambda4
twocbcl_q102_p*lambda5
'
