...
### 1 year follow up family history data
...
## This is being done for family history data offered at One year follow up!
    ##### Important to note: ONE YEAR DATA OF THIS DOES NOT EXIST 
...
#write into csv
write.csv(FHtotal, "OneFHtotal.csv")
