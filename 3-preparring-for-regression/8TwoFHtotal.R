...
### 2 year follow up family history data
...
## This is being done for family history data offered at Two  year follow up!
##### Important to note: TWO YEAR DATA OF THIS DOES NOT EXIST 
...
#write into csv
write.csv(FHtotal, "TwoFHtotal.csv")
